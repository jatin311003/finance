                ...
                <div className='flex gap-2'>
                    ...
                    {selectedIds.length!==0&&(<div>
                        ...
                        {(searchTerm||typeFilter||recurringFilter)&&(
                            <Button variant="outline" size="icon" onClick={handleClearFilters} title="Clera Filters">
                                <X className='h-4 w-5 '/>
                            </Button>
                        )}
                        ...
                        {filteredAndSortedTransactions.length === 0 ? (
                            ...
                            filteredAndSortedTransactions.map((transaction) => (
                                ...
                                <TableRow key={transaction.id}>
                                    ...
                                    <TableCell className="text-right fpont-medium" style={{ color: transaction.type === "EXPENSE" ? "red" : "green" }}>
                                    ...
                                    <TableCell>
                                        ...
                                        ) : (<Badge variant={"outline"} className={"gap-1 bg-purple text-purple-700 hover:bg-purple-200"}>
